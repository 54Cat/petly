...
export const NoticesCategoriesItem = ({ notice, favorite, updateFavorite, deleteMyNotices }) => {
    ...
    const addToFavorite = async() =>
        isLoggedIn ? dispatch(updateFavorite(_id)) :
            ...
            <NoticesCardThumb>
                ...
                <BtnThumb>
                    ...
                    {(isLoggedIn && auth.user._id === owner) ?
                        <BtnDelete className='btnDel' type='button' onClick={deleteNotices}>Delete
                            <BasketWraper >
                                <Basket width="16" height="18" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
